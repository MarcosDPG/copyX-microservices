...
urlpatterns = [
    ...
    path("like/<str:object_id>", views.like_operations, name="like_object_id"),
    path("like/<str:object_id>/<int:content_type>", views.like_operations, name="like_object_id_content_type"),
